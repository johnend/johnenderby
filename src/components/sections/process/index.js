    ...
    <section id="process" className={styles.process}>
      ...
      <div className={styles.content}>
        <p>
          ...
          methodical <span role="img" aria-label="Test tube emoji">🧪</span> while I'm being creative <span role="img" aria-label="artist's palette emoji">🎨</span>. The designer's method isn't
          ...
          closer and closer to a solution. In order to get to a solution there often needs to be a fair amount of compromise.
          Compromise on time, efficiencies, or future proofing. Ultimately it's
          about making the decision that feels right, at the right time <span role="img" aria-label="Heart emoji">❤️</span>.
        </p>
        <p>
          Once we have a solution in place to a problem <span role="img" aria-label="checked box emoji">✅</span> it all starts over
          again with another one, or maybe an expansion on something previously
          considered. Each of these small pieces fit together in the puzzle <span role="img" aria-label="jigsaw puzzle piece emoji">🧩</span>
          ...
          foundation. Complex products and interactions are what make me tick <span role="img" aria-label="watch emoji">⌚</span>
