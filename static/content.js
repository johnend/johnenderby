...
export const socialData = [
  {
    ...
    subtitle: "The home of doom scrolling, fun times!",
  },
  {
    network: "Dribbble",
    iconName: "Dribbble",
    link: "https://dribbble.com/johnend87",
    subtitle: "If you’re not Dribbblin’ as a designer… 🤤",
  },
  {
    network: "GitHub",
    iconName: "GitHub",
    link: "https://github.com/johnend",
    subtitle: "I don’t have that many green dots… 🟩",
  },
  {
    network: "Spotify",
    iconName: "Spotify",
    link: "https://open.spotify.com/user/johnend",
    subtitle: "Listen to what I’m listening to? 🤷‍♂️",
  },
  {
    network: "PSN",
    iconName: "PSN",
    subtitle: "More often on the PC, until the PS5 comes out…",
    sharingInfo: "johnend",
  },
  {
    network: "Pokémon Go",
